...
// SSR · Saathibook Product Page · SEO indexed
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: dict.saathibook.seo.title,
    description: dict.saathibook.seo.description,
  }
}
...
export default async function SaathibookPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params
  const dict = await getDictionary(locale)
      ...
      <section className="px-6 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-zinc-500 text-center mb-16 max-w-lg mx-auto">
            Stop wasting mornings in status meetings. Saathibook gives you that time back.
          </p>
      ...
      <section id="contact" className="px-6 py-24">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-zinc-500 text-center text-sm mb-12">
            Saathibook is rolling out in phases. Get in queue.
          </p>
          <form
            ...
            className="space-y-4"
          >
            <input type="hidden" name="section" value="saathibook" />
            ...
            <div>
              ...
              <textarea name="message" rows={3} placeholder="What would you use Saathibook for?" className="form-input resize-none" />
            </div>
            <button
              type="submit"
