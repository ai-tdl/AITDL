...
export const metadata: Metadata = {
  title: 'Dailyboard — Daily Goals & Team Sync',
  description: 'Track daily goals, run async standups, and keep your team aligned — with AI assistance. Built for solo professionals and teams across India.',
  keywords: ['Dailyboard', 'daily goals', 'team sync', 'productivity', 'AI assistant', 'standup', 'AITDL'],
  openGraph: {
    title: 'Dailyboard — Daily Goals & Team Sync | AITDL',
    description: 'Daily goals, async standups, progress boards. AI-powered team productivity.',
  },
}
      ...
      <section className="relative px-6 pt-20 pb-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-display text-6xl md:text-7xl font-extrabold text-white mb-6 leading-none tracking-tight">
            Daily<span className="text-gradient">board</span>
          </h1>

          <p className="text-xl text-zinc-300 max-w-2xl mx-auto mb-4">
            Daily goals, async standups, and team sync — powered by AI.
          </p>
