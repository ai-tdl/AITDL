...
### Phase 9: Intelligent Location Selector
-   [x] Seed location dataset (`india-locations.ts`) <!-- id: 43 -->
-   [x] Build `LocationSelector.tsx` component <!-- id: 44 -->
-   [x] Integrate into Contact and Partner forms <!-- id: 45 -->
-   [x] Update Implementation Ledger and Cookbook <!-- id: 46 -->
...
## Chapter 23: Intelligent Location Selection

To maintain data integrity and professional UX, use the `LocationSelector` for all Indian address fields.

### Implementation Checklist:
1.  **Import**: `import LocationSelector from '@/components/forms/LocationSelector'`
